...
def extractBitPlane(imageNdArray, bitOrder):
    bits = imageNdArray >> bitOrder
    isBlackOrWhite = bits & 1

    return (isBlackOrWhite * 255).astype(np.uint8)
...
baboonBitPlane0 = extractBitPlane(imageNdArray=originalImg, bitOrder=0)
baboonBitPlane4 = extractBitPlane(imageNdArray=originalImg, bitOrder=4)
baboonBitPlane7 = extractBitPlane(imageNdArray=originalImg, bitOrder=7)

saveImage(imageNdArray=baboonBitPlane0, name="baboon_bit_plane_0", imgType="png")
saveImage(imageNdArray=baboonBitPlane4, name="baboon_bit_plane_4", imgType="png")
saveImage(imageNdArray=baboonBitPlane7, name="baboon_bit_plane_7", imgType="png")
